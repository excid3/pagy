...
describe Pagy::Frontend do
  ...
  describe "I18N" do
    ...
    it 'sets the :default_locale with default load' do
      Pagy::Frontend::I18N[:default_locale].must_equal 'en'
    end

    it 'sets the :default_locale with custom load' do
      Pagy::Frontend::I18N.load({locale: 'es'}, {locale: 'de'})
      Pagy::Frontend::I18N[:default_locale].must_equal 'es'
      Pagy::Frontend::I18N.load # reset for other tests
    end

    it 'explicitly sets the :default_locale with custom load' do
      Pagy::Frontend::I18N.load({locale: 'es'}, {locale: 'de'})
      Pagy::Frontend::I18N[:default_locale] = 'de'
      Pagy::Frontend::I18N[:default_locale].must_equal 'de'
      Pagy::Frontend::I18N.load # reset for other tests
    end
    ...
    it 'switches :locale according to @pagy_locale' do
      ...
      frontend.pagy_t('pagy.info.item_name', count: 1).must_equal "Eintrag" # silently serves the default_locale
      Pagy::Frontend::I18N.load # reset for other tests
    end
  end
